#ifndef LIBPKGUPD_ARCHIVE_MANAGER_APPIMAGE_HH
#define LIBPKGUPD_ARCHIVE_MANAGER_APPIMAGE_HH

#include "../squash/squash.hxx"

namespace rlxos::libpkgupd {
    class AppImage : public Squash {
    public:
        bool get_offset(char const *path, std::string &offset);
