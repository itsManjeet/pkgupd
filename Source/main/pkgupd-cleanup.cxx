#include "../libpkgupd/common.hxx"
#include "../libpkgupd/configuration.hxx"
#include "../libpkgupd/defines.hxx"
...
PKGUPD_MODULE(cleanup) {
  auto pkg_dir = config->get<std::string>(DIR_PKGS, DEFAULT_PKGS_DIR);
  auto src_dir = config->get<std::string>(DIR_SRC, DEFAULT_SRC_DIR);
